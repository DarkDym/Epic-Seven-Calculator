...
class DynamicWidgetsApp(App):
    ...
    def __init__(self, **kwargs):
        ...
        self.name_to_phone = {"Achates-Icon-1.png": "0414144411", "Violet-icon.png": "0441411211", "Yufine-icon.jpg": "0432123456"}

    def build(self):
        """Build the Kivy GUI."""
        self.title = "Dynamic Widgets"
        self.root = Builder.load_file('t.kv')
        # self.create_widgets()
        return self.root
    ...
    def create_widgets(self):
        ...
        for name in self.name_to_phone:
            ...
            temp_button = Button(text=name,background_normal="./imgs/"+str(name))
